...
namespace TorrentParser_CLI
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // string pseudourl = "https://torlook.info/Minecraft";
            torrentParser.AddXmlNamespace(LinkedUrl);
            ...
            for (int i = 1; i < SearchInt; i++)
            {
                ...
                var seeders = doc.DocumentNode.SelectSingleNode("//*[@id=\"resultsDiv\"]/*[contains(@class, \"webResult item\")][2]/*[@class=\"h2\"]/*[@class=\"webResultTitle\"]/*[@class=\"torstat\"]/*[@class=\"seeders\"]").InnerText;
                var leechers = doc.DocumentNode.SelectSingleNode("//*[@id=\"resultsDiv\"]/*[contains(@class, \"webResult item\")][2]/*[@class=\"h2\"]/*[@class=\"webResultTitle\"]/*[@class=\"torstat\"]/*[@class=\"leechers\"]").InnerText;
